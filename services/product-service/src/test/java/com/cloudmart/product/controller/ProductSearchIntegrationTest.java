...
class ProductSearchIntegrationTest {
    ...
    void setUp() {
        ...
        restTemplate.postForEntity("/api/v1/products",
                new ProductRequest("Gaming Laptop", "High-end gaming laptop", new BigDecimal("1500.00"),
                        null, "COMP-001", electronics.getId()), ProductResponse.class);
        restTemplate.postForEntity("/api/v1/products",
                new ProductRequest("Office Laptop", "Business laptop for office use", new BigDecimal("800.00"),
                        null, "COMP-002", electronics.getId()), ProductResponse.class);
        restTemplate.postForEntity("/api/v1/products",
                new ProductRequest("Cotton T-Shirt", "Comfortable cotton t-shirt", new BigDecimal("25.00"),
                        null, "CLO-001", clothing.getId()), ProductResponse.class);
        restTemplate.postForEntity("/api/v1/products",
                new ProductRequest("Winter Jacket", "Warm winter jacket", new BigDecimal("120.00"),
                        null, "CLO-002", clothing.getId()), ProductResponse.class);
    }
